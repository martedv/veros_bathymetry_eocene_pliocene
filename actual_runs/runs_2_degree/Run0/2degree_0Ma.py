...
class GlobalFlexibleResolutionSetup(VerosSetup):
    ...
    def set_diagnostics(self, vs):
        vs.diagnostics['snapshot'].output_frequency = self.writeper * 86400.
        vs.diagnostics['overturning'].output_frequency = self.writeper * 86400.
        vs.diagnostics['overturning'].sampling_frequency = vs.dt_tracer
        vs.diagnostics['energy'].output_frequency = self.writeper * 86400.
        ...
        vs.diagnostics['averages'].output_frequency = self.writeper * 86400.
