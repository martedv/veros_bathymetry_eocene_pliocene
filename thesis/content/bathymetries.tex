...
\caption{Oligocene bathymetries showing: \textbf{(a)} The bathymetry of 30 Ma. \textbf{(b)} The bathymetry of 25 Ma.}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=\linewidth]{bathymetries_miocene.pdf}
	\caption{Miocene bathymetries showing \textbf{(a)} The bathymetry of 20 Ma. \textbf{(b)} The bathymetry of 15 Ma. \textbf{(c)} The bathymetry of 10 Ma.}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=\linewidth]{bathymetries_pliocene.pdf}
	\caption{Miocene bathymetries showing \textbf{(a)} The bathymetry of 5 Ma. \textbf{(b)} The present day bathymetry}
\end{figure}
\begin{multicols}{2}
