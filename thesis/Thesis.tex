...
\noindent\rule{\textwidth}{1pt}
\begin{multicols}{2}
\todo[inline, color=green!40]{The abstract still needs some work as my conclusions are still so weak.  Formatting the document is also not finalized. Some half empty pages are still present. But dealing with formatting is not efficient when the paper is not in its final state. }
